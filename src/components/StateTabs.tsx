    ...
    <div className="flex items-center flex-wrap gap-2.5 pb-2">
      ...
      >
        ...
        <span
          className={`text-[12px] font-medium rounded-full px-2 py-0.5 ${
            selected === "ALL" ? "bg-on-primary/12 text-on-primary/80" : "bg-surface-container text-on-surface-variant"
          }`}
        >
      ...
      {states.map((s) => (
        ...
        >
          ...
          <span
            className={`text-[12px] font-medium rounded-full px-2 py-0.5 ${
              selected === s.code ? "bg-on-primary/12 text-on-primary/80" : "bg-surface-container text-on-surface-variant"
            }`}
          >
